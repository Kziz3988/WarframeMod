...
public class NullStar() : WarframeModCard(1, CardType.Skill, CardRarity.Common, TargetType.Self)
{
    ...
    {
        await PowerCmd.Apply<NullStarPower>(choiceContext, base.Owner.Creature, base.DynamicVars["NullStarPower"].BaseValue, base.Owner.Creature, this);
    }
